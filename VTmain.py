...
def vtmain(address, i):
    ...
    try:
        ...
        print(f"IP {i}/{len(ips)} Response for {address}: {Style.YELLOW} {vt_response.text}{Style.RESET}")
...
if __name__ == "__main__":
    ...
    for i, ip in enumerate(ips):
        ...
        if not address.is_private:
            ...
            print(f"\tEntire output (For debugging): {vt_response_json}")
